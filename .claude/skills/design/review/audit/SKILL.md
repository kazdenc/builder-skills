---
name: audit
description: Perform comprehensive audit of interface quality across accessibility, performance, theming, and responsive design. Use when user says "audit this", "check accessibility", "review quality", "find issues", "run diagnostics", "a11y check", or wants a detailed quality report with severity ratings.
args:
  - name: area
