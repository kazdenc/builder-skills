---
name: animate
description: Review a feature and enhance it with purposeful animations, micro-interactions, and motion effects that improve usability and delight. Use when user says "add animations", "add motion", "make it move", "add micro-interactions", "add transitions", or wants to enhance a static interface with motion.
args:
  - name: target
