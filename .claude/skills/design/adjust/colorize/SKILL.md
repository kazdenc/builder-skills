---
name: colorize
description: Add strategic color to features that are too monochromatic or lack visual interest. Use when user says "add color", "too gray", "too monochrome", "needs color", "more colorful", or wants to add visual warmth to a neutral interface.
args:
  - name: target
