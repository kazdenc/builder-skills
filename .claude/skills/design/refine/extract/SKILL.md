---
name: extract
description: Extract and consolidate reusable components, design tokens, and patterns into your design system. Use when user says "extract components", "create a design system", "make this reusable", "componentize this", "build a component library", or wants to consolidate patterns into a shared library.
args:
  - name: target
