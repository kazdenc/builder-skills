---
name: onboard
description: Design or improve onboarding flows, empty states, and first-time user experiences. Use when user says "add onboarding", "empty state", "first-time experience", "welcome flow", "getting started", "new user experience", or needs to help users understand and adopt the product.
args:
  - name: target
